...
def print_cow():
    print(" ___________ ")
    print(" \033[07m  pass.py! \033[27m                # Common")
    print("      \                     # User")
    print("       \   \033[1;31m,__,\033[1;m             # Passwords")
    print("        \  \033[1;31m(\033[1;moo\033[1;31m)____\033[1;m         # Profiler")
    print("           \033[1;31m(__)    )\ \033[1;m  ")
    print(
        "           \033[1;31m   ||--|| \033[1;m\033[05m*\033[25m\033[1;m      [ BM Hacker | h1ckpro.tk ]"
    )
    print(28 * " " + "[ BM Hacker | https://github.com/bmh1cker]\r\n")


def version():
    """Display version"""

    print("\r\n	\033[1;31m[ pass.py ]  " + __version__ + "\033[1;m\r\n")
    print("	* Hacked up by BM Hacker - h1ckpro.tk")
...
def improve_dictionary(file_to_open):
    ...
    if leetmode == "y":
        for (
            ...
            unique_lista
        ):  # if you want to add more leet chars, you will need to add more lines in pass.cfg too...
    ...
    print_to_file(file_to_open + ".pass.txt", unique_list_finished)
...
# the main function
def main():
    """Command-line interface to the pass utility"""

    read_config(os.path.join(os.path.dirname(os.path.realpath(__file__)), "pass.cfg"))
